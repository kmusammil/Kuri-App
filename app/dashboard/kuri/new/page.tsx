...
export default async function NewKuriPage({
  ...
  const canCreateKuri = role === "MAIN_ADMIN" || role === "ADMIN";
      ...
      <div className="mx-auto max-w-3xl">
        ...
        {!canCreateKuri ? (
          <div className="rounded-2xl border border-amber-200 bg-amber-50 p-6 text-sm text-amber-800">
            Your workspace role does not permit creating Kuri schemes. An administrator must grant ADMIN or MAIN_ADMIN access.
          </div>
        ) : (
