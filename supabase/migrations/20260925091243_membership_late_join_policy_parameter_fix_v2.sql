...
BEGIN
  ...
  FOR v_cycle_no IN 1..kuri_row.number_of_cycles LOOP
    v_cycle_start:=(kuri_row.start_date+((v_cycle_no-1)*interval '1 month'))::date;
    ...
    VALUES(
      target_kuri_id,v_cycle_no,v_cycle_start,v_cycle_end,v_due_date,v_draw_date,'UPCOMING'
    )
    ...
    v_inserted_cycles:=v_inserted_cycles+1;
  END LOOP;
